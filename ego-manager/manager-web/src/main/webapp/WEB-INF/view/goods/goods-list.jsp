...
<table class="easyui-datagrid" id="itemList" title="商品列表"
    ...
    <tr>
        ...
        <th data-options="field:'isOnSale',width:60,align:'center',formatter:ego.formatItemStatus">状态</th>
    ...
    var toolbar = [{
                    ...
                    $.getJSON('/rest/goods/param/goods/query/' + data.id, function (_data) {
                        if (_data && _data.status == 200 && _data.data && _data.data.paramData) {
                            ...
                            for (var i in paramData) {
                                var pd = paramData[i];
                                html += "<li><input type=\"hidden\" value='" + pd.catId + "'/>";
                                html += "<table>";
        ...
        handler: function () {
            ...
            $.messager.confirm('确认', '确定删除ID为 ' + ids + ' 的商品吗？', function (r) {
                if (r) {
                    var params = {"ids": ids};
                    $.post("/rest/goods/delete", params, function (data) {
                        if (data.status == 200) {
