...
<body class="easyui-layout">
    	...
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	<li>
         		...
         		<ul>
                    ...
                    <li data-options="attributes:{'url':'${ctx }/goods/category'}">分类管理</li>
	         		<li data-options="attributes:{'url':'${ctx }/goods/param-list'}">规格参数</li>
	         	</ul>
         	</li>
         	<li>
         		<span>网站内容管理</span>
         		<ul>
	         		<li data-options="attributes:{'url':'${ctx }/content/category'}">内容分类管理</li>
    ...
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">北京尚学堂@2017</div>
    </div>
