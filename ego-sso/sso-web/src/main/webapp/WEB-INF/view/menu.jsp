...
<div id="s_cats">
	...
	<script type="text/javascript">
		$(function() {
			$
					.ajax({
						url : "http://localhost:8081/goods/cat/getAllMenu",
						dataType : "jsonp",
						jsonp : "callBackFun",
						success : function(res) {
							...
							for (i = 0; i < res.length; i++) {
								...
								htmlStr += '<h4 class="cat_tit"><a href="#" class="cat_tit_link">'
										+ level_1.text
										+ '</a><span class="s_arrow">></span></h4>';
